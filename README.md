...
- 🎨 **Theme Support** - Dark and light modes with native OS titlebar sync
...
- **Open Files**: Click the folder icon (📁) or use `Ctrl/Cmd + O`
- **Switch Tabs**: Click on tabs to switch between files
- **Table of Contents**: Click headings to navigate, collapse/expand sections
- **Theme Toggle**: Click sun/moon icon (🌙) or use `Ctrl/Cmd + T`
...
- Inspired by VSCode's minimalist design
